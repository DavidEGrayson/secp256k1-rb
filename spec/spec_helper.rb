...
ExampleSig1 = OpenStruct.new.tap do |e|
  ...
  e.extra_entropy =
    "\xda\xda\x32\x6f\x68\x31\xa6\xc3" \
    "\xaa\x87\x4d\x3c\xb8\x70\x15\xef" \
    "\x66\x18\xfe\xed\x33\x84\x7f\x46" \
    "\xfb\xc8\x04\x14\x84\x44\x55\xa7"
  ...
  e.nonce_rfc6979_0_extra_entropy =
    "\x97\xcd\xa4\x46\x95\xa1\xf2\x06" \
    "\x12\xe4\x81\x72\x18\xec\x91\x08" \
    "\xca\xe5\x93\x10\x41\x6a\x7f\x26" \
    "\x81\xe8\x3d\xd0\x5a\x78\x8f\x09"
...
Example2 = OpenStruct.new.tap do |e|
  ...
  e.privkey_product =
    "\xd6\x6c\xc8\xc2\xf1\x3d\x8e\xb7\x49\x80\xfe\xae\xb9\xf3\xb7\x50" \
    "\xf0\x65\x13\x10\xe4\xc2\x8c\x4c\x6a\x65\x66\xe4\xb9\xec\x13\x06"

  e.pubkey1 =
    "\x03" \
    "\x2c\x0b\x7c\xf9\x53\x24\xa0\x7d\x05\x39\x8b\x24\x01\x74\xdc\x0c" \
    "\x2b\xe4\x44\xd9\x6b\x15\x9a\xa6\xc7\xf7\xb1\xe6\x68\x68\x09\x91"

  e.pubkey2 =
    "\x03" \
    "\x4f\x35\x5b\xdc\xb7\xcc\x0a\xf7\x28\xef\x3c\xce\xb9\x61\x5d\x90" \
    "\x68\x4b\xb5\xb2\xca\x5f\x85\x9a\xb0\xf0\xb7\x04\x07\x58\x71\xaa"

  e.pubkey_sum =
    "\x02" \
    "\x9a\xc2\x03\x35\xeb\x38\x76\x8d\x20\x52\xbe\x1d\xbb\xc3\xc8\xf6" \
    "\x17\x84\x07\x45\x8e\x51\xe6\xb4\xad\x22\xf1\xd9\x17\x58\x89\x5b"

  e.pubkey_product =
    "\x03" \
    "\x3b\x8a\xb0\x08\x3e\xe2\x60\x30\x22\xa2\xca\xdc\x0d\xfa\x20\x00" \
    "\xc0\x5d\x84\xea\x61\x3d\xc9\x75\xd8\x96\x2d\x57\x2c\xca\xb6\x69"

  e.pubkey1_uncompressed =
    "\x04" \
    "\x2c\x0b\x7c\xf9\x53\x24\xa0\x7d\x05\x39\x8b\x24\x01\x74\xdc\x0c" \
    "\x2b\xe4\x44\xd9\x6b\x15\x9a\xa6\xc7\xf7\xb1\xe6\x68\x68\x09\x91" \
    "\xae\x31\xa9\xc6\x71\xa3\x65\x43\xf4\x6c\xea\x8f\xce\x69\x84\x60" \
    "\x8a\xa3\x16\xaa\x04\x72\xa7\xee\xd0\x88\x47\x44\x02\x18\xcb\x2f"

  e.pubkey_sum_uncompressed =
    "\x04" \
    "\x9a\xc2\x03\x35\xeb\x38\x76\x8d\x20\x52\xbe\x1d\xbb\xc3\xc8\xf6" \
    "\x17\x84\x07\x45\x8e\x51\xe6\xb4\xad\x22\xf1\xd9\x17\x58\x89\x5b" \
    "\xaf\x10\x2a\x60\x3f\xa0\x9b\x36\x67\x05\xfd\x72\x77\x57\xa5\xab" \
    "\xd6\x14\x41\x0a\x6e\x3f\x80\x2a\xb8\xda\x8d\xfe\x84\x28\x9d\x64"

  e.pubkey_product_uncompressed =
    "\x04" \
    "\x3b\x8a\xb0\x08\x3e\xe2\x60\x30\x22\xa2\xca\xdc\x0d\xfa\x20\x00" \
    "\xc0\x5d\x84\xea\x61\x3d\xc9\x75\xd8\x96\x2d\x57\x2c\xca\xb6\x69" \
    "\xd7\x3d\xda\x3e\xe3\x54\xc8\x98\xac\xf3\x77\xeb\xe7\x4b\x2c\x95" \
    "\x22\x78\xac\x3a\xb4\x87\xff\xb9\x8a\xac\xe7\x44\xcb\x3d\xec\x31"
end
