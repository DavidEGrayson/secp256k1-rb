...
ExampleSig1 = OpenStruct.new.tap do |e|
  ...
  # Signature generated by the Ruby ecdsa gem.
  # TODO: why is this signature different?  It was generated with:
  # e.signature_alt = ECDSA::Format::SignatureDerString.encode(ECDSA.sign(ECDSA::Group::Secp256k1, ECDSA::Format::IntegerOctetString.decode(e.secret_key), e.message_hash, ECDSA::Format::IntegerOctetString.decode(e.nonce)))
